...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py4">
                    ...
                    @foreach($posts as $post)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <button wire:click="delete({{ $post->id }})"class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
